...
export function JuegoPrecios() {
  ...
  const iconoResultado = (r: ResultadoIntento) => {
    if (r === 'correcto') return <Star className="text-yellow-500 fill-yellow-500" size={18} />
    if (r === 'tolerancia') return <Star className="text-gray-400 fill-gray-400" size={18} />
    if (r === 'alto') return <ArrowDown className="text-red-500" size={18} />
    return <ArrowUp className="text-blue-500" size={18} />
  }
  ...
  if (estado === 'cargando') {
    return <Layout><LoadingSpinner text="Cargando producto..." /></Layout>
  }
    ...
    <Layout>
      <div className="pt-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Juego de precios</h1>
            <p className="text-sm text-gray-500">¿Sabes cuánto cuesta?</p>
          </div>
          <button
        ...
        {producto && (
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-6">
            ...
            <div className="p-5">
              ...
              <h2 className="font-semibold text-gray-900 text-base mb-3 line-clamp-2">
                {producto.name}
              </h2>
              ...
              {estado === 'ganado' && (
                <div className="text-center py-4">
                  ...
                  <p className="text-primary-600 font-bold text-2xl mt-1">
                    {producto.price.toFixed(2)} €
                  </p>
                  <button
                    onClick={cargarProducto}
                    className="mt-4 w-full py-3 bg-primary-600 text-white rounded-2xl font-medium hover:bg-primary-700 active:scale-95 transition-all"
                  >
                    Siguiente producto
                  </button>
                </div>
              ...
              {estado === 'perdido' && (
                <div className="text-center py-4">
                  ...
                  <button
                    onClick={cargarProducto}
                    className="mt-4 w-full py-3 bg-gray-800 text-white rounded-2xl font-medium hover:bg-gray-900 active:scale-95 transition-all"
                  >
                    Intentar de nuevo
                  </button>
                </div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-base font-semibold focus:outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100 transition-all"
                        autoFocus
                      />
                    </div>
                    <button
