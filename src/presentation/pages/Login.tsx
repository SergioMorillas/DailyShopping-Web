      ...
      <div className="flex-1 flex items-center justify-center px-5 py-8">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/40 text-sm font-medium mt-1">Inicia sesión para continuar</p>
          </div>
          ...
          <div className="bg-white/8 backdrop-blur-sm rounded-3xl p-6 border border-white/10">
            ...
            <p className="text-center text-xs text-white/40 font-medium mt-5">
              ¿Sin cuenta?{' '}
              <Link to="/registro" className="text-[#04bcd4] font-bold hover:text-[#5dd9ea] transition-colors">
                Regístrate gratis
              </Link>
            </p>
          </div>
